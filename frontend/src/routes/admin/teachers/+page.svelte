...
<Dialog.Root bind:open={IsOpen}>
	<Dialog.Trigger class={buttonVariants({ variant: "outline" })}>Add New Teacher</Dialog.Trigger>
	<Dialog.Content class="w-fit">
		<Dialog.Header>
			<Dialog.Title>Add New Teacher</Dialog.Title>
			<Dialog.Description>
				Enter the details here. Click save when you're done.
			</Dialog.Description>
		</Dialog.Header>
